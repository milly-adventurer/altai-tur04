...
const BookModal = (props: BookModalProps) => {
	...
	const onSubmit = (e: FormEvent<HTMLFormElement>) => {
		...
		if (email.trim().length) {
			...
			axios.post('https://functions.yandexcloud.net/d4ej4p6rkjtduova4fkj', null, { params: {email, phone, name, price: calculatedPrice, quantity, tourId, date, formName: 'Бронь' }});
			setIsSubmitted(true);
			// @ts-ignore
